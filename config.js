...
MENU_IMAGE_URL: process.env.MENU_IMAGE_URL || "https://files.catbox.moe/eqf8b0.jpg",
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "254785392165XXXX",
// add your bot owner number
OWNER_NAME: process.env.OWNER_NAME || "Pk Driller",
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ Pk Driller*",
// add bot owner name    
ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/eqf8b0.jpg",
